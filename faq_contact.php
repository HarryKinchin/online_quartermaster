...
<div class="accordion">
    <div class="accordion-item">
        ...
        <div class="accordion-content">
            <p>We collect the information you provide when you sign up or use our services. This includes your <strong>name</strong>, <strong>email address</strong>, and <strong>password</strong>. We need this data to create your account, provide our services, and contact you if necessary.</p>
        </div>
    </div>
    ...
    <div class="accordion-item">
        ...
        <div class="accordion-content">
            <p>Your data is protected using a combination of technical and administrative measures designed to keep it safe.</p>
            <ul>
                <li><strong>Passwords:</strong> Your password is never stored in plain text. Instead, we use a process called <strong>hashing</strong> and <strong>salting</strong> to turn your password into a long string of random characters that cannot be reversed. This means that even in the unlikely event of a data breach, your actual password remains unreadable. </li>
                <li><strong>Data Encryption:</strong> All data transmitted between your browser and our servers is encrypted using <strong>SSL/TLS (Secure Sockets Layer/Transport Layer Security)</strong>. This creates a secure, encrypted connection that protects your information from being intercepted while in transit.</li>
                <li><strong>Access Control:</strong> Access to your personal data is restricted to authorized personnel only, and their access is strictly limited to what is necessary to perform their jobs.</li>
            </ul>
        </div>
    </div>
    ...
    <div class="accordion-item">
        ...
        <div class="accordion-content">
            <p>We retain your personal data for as long as your account is active or as needed to provide you with our services. If you choose to delete your account, we will permanently remove your personal data from our systems, except for any information we are required to retain by law for legal or regulatory purposes.</p>
        </div>
    </div>
    ...
    <div class="accordion-item">
        ...
        <div class="accordion-content">
            <p>We do not sell or rent your personal information to third parties. We may share your data with trusted partners and service providers who assist us in operating our website and providing services to you (e.g., payment processors or email providers), but only under strict confidentiality agreements.</p>
        </div>
    </div>
...
<div class="form-container" style="max-width: 600px; margin: 2rem auto; text-align: center;">
    <h3 class="form-title">Get in Touch</h3>
    <p>Please email us directly at <a href="mailto:<?= htmlspecialchars(getenv('QM_SMTP_USERNAME')) ?>"><?= htmlspecialchars(getenv('QM_SMTP_USERNAME')) ?></a></p>
</div>
